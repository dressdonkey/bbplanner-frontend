...
@Component({
  selector: 'app-edit-association-logo',
  templateUrl: './edit-association-logo.component.html',
  styleUrls: ['./edit-association-logo.component.css']
})

export class EditAssociationLogoComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<EditAssociationLogoComponent>,
  ...
  onUploadOutput(output: UploadOutput): void {
    ...
    if (output.type === 'allAddedToQueue') { // when all files added in queue
      ...
      if(output.file.responseStatus == 400){
        ...
        this.association.logo = output.file.response.association.logo;  
  ...
  startUpload(id): void {
    ...
    const event: UploadInput = {
      type: 'uploadFile',
      url: 'http://192.168.33.10/api/associations/upload/'+id,
      method: 'POST',
      data: { 
        id: id 
      },
